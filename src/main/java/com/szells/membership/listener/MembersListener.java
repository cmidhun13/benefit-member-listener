...
import static com.szells.membership.constants.Constants.MEMBER_BULK_UPLOAD_TOPIC_NAME;
...
public class MembersListener {
    ...
    @KafkaListener(topics = "member.activate", containerFactory = "activateMemberListenerFactory")
    ...
    @KafkaListener(topics = "member.suspend", containerFactory = "suspendMemberListenerFactory")
    ...
    @KafkaListener(topics = "member.create", containerFactory = "createMemberListenerFactory")
