...
public interface IWelcomeTemplate {
    ...
    static String emailContent(String member_name) {
        ...
        return "\n" +
                ...
                "                    <p style=\"margin: 0 !important;font-size: 20px;margin-bottom: 11px !important;\">Please <a href=\"http://ec2-3-15-27-247.us-east-2.compute.amazonaws.com:8080/\" style=\"    text-decoration: none;color: #17e0e2;font-weight: bold;\">login here</a> with your username and password to enroll in our customized packages created specifically for you.</p>\n" +
                ...
                "                   \n" +
                "                    <p style=\"margin: 0 !important;font-size: 20px;margin-bottom: 50px !important;margin-top: 50px !important;\"><a href=\"http://ec2-3-15-27-247.us-east-2.compute.amazonaws.com:8080/\" style=\"    text-decoration: none;color: #17e0e2;font-weight: bold;\">http://ec2-3-15-27-247.us-east-2.compute.amazonaws.com:8080</a></p>\n" +
        ...
        /*return "<!DOCTYPE html>\n"
                ...
                + "<p style=\"margin: 0 !important;font-size: 20px;margin-bottom: 11px !important;\">You could also copy the below link and paste in your browser address bar</p>\n"
                + "<p style=\"margin: 0 !important;font-size: 20px;margin-bottom: 50px !important;margin-top: 50px !important;\"><a href=\"http://ec2-18-219-247-17.us-east-2.compute.amazonaws.com:9080/login\" style=\"text-decoration: none;color: #17e0e2;font-weight: bold;\">http://ec2-18-219-247-17.us-east-2.compute.amazonaws.com:9080/login</a></p>\n"
                + "<p style=\"margin: 0 !important;font-size: 20px;margin-bottom: 11px !important;\">Thanks,</p>\n"
                + "<p style=\"margin: 0 !important;font-size: 20px;margin-bottom: 11px !important;\">Szells Team</p>\n"
                + "</td>\n"
                + "</tr>\n"
