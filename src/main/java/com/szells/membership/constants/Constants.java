...
public class Constants {
    ...
    // Topic Names
    public static final String CREATE_TOPIC_NAME = "membership.create";
    public static final String DELETE_TOPIC_NAME = "membership.delete";
    public static final String UPDATE_TOPIC_NAME = "membership.update";
