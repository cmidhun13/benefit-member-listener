...
public class MemberController {
    ...
    public Mono<GenericResponse<Integer>> onboardEmail(@RequestHeader(name = Constants.CORRELATION_ID) String correlationId,
        ...
        return memberService.onBoardMemberMembershipEmail(MembershipPreProcessor.getBuild(correlationId, visibilityScopeKey, null, null, null, payload));
    ...
    public Mono<GenericResponse<Boolean>> enroll(@RequestHeader(name = Constants.CORRELATION_ID) String correlationId,
                                                 @RequestHeader(name = Constants.X_VISIBILITY_SCOPE_KEY) String visibilityScopeKey,
    ...
    public Mono<GenericResponse<Object>> fileUpload(@RequestHeader(name = Constants.CORRELATION_ID) String correlationId,
                                                       @RequestHeader(name = Constants.X_VISIBILITY_SCOPE_KEY) String visibilityScopeKey,
    ...
    public Mono<GenericResponse<String>> onboardXls(@RequestHeader(name = Constants.CORRELATION_ID) String correlationId,
                                                     @RequestHeader(name = Constants.X_VISIBILITY_SCOPE_KEY) String visibilityScopeKey,
                                                     @RequestBody @Valid BulkUploadMember bulkUploadMember) {
        ServiceParameters<BulkUploadMember> parameters = MembershipPreProcessor
                .getBuild(correlationId, visibilityScopeKey, null, null, null, bulkUploadMember);
        return memberService.processBulkUploadMembersProfile(parameters);
    }
    @PostMapping(value = "/member/status")
    public Mono<GenericResponse<Boolean>> mesuspend(@RequestHeader(name = Constants.CORRELATION_ID) String correlationId,
                                                     @RequestHeader(name = Constants.X_VISIBILITY_SCOPE_KEY) String visibilityScopeKey,
